...
exports.ArenaTokenService = void 0;
// @ts-ignore
...
var ArenaTokenService = /** @class */ (function () {
    function ArenaTokenService(fungibleTokenAddress, arenaTokenAddress) {
        this.fungibleTokenAddress = fungibleTokenAddress;
        this.arenaTokenAddress = arenaTokenAddress;
    }
    ArenaTokenService.prototype.sendArena = function (recipient, amount) {
    ...
    ArenaTokenService.prototype.setupAccount = function (recipient) {
    ...
    ArenaTokenService.prototype.getBalance = function (target) {
    ...
    return ArenaTokenService;
}());
exports.ArenaTokenService = ArenaTokenService;
